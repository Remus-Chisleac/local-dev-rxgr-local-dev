 ...
 * from the catalog (see preorder2-page.js).
 *
...
(function (global) {
  ...
  function csrfToken() {
    return (
      ...
      (document.querySelector('[data-aico-preorder2] input[name="_token"]') || {}).value ||
      ''
    );
  }
   ...
   * pusher channel (see preorder2-confirmation.js). No client-side status
