/**
 * Preorder2 cart — isolated from preorder-cart.js (/preorder).
 */
(function (global) {
  'use strict';
  ...
  CartController.prototype.updateQuantity = function (
    ...
    if (global.AicoPreorder2Stock) {
      global.AicoPreorder2Stock.adjustStock(productId, variantId, dateLabel, quantity);
    }
