/**
 * Preorder2 landing — same flow as preorder-page.js, header-size catalog layout.
 */
(function () {
  'use strict';
  ...
  function setupPreorderWorkflow(root, opts) {
    if (!window.AicoPreorder2Catalog) return;
    ...
    catalog = new window.AicoPreorder2Catalog.CatalogController({
      root: root,
